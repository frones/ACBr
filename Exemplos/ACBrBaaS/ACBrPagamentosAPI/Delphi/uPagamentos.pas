...
begin
  if (MessageDlg('Deseja zerar a lista de lançamentos?', mtConfirmation, [mbYes,mbNo], 0) = mrNo) then
    Exit;
...
begin
  if (MessageDlg('Deseja incluir o lançamento atual?', mtConfirmation, [mbYes,mbNo], 0) = mrNo) then
    Exit;
