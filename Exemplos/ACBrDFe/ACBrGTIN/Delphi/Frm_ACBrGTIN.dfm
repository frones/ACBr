object frmACBrGTIN: TfrmACBrGTIN
  Left = 249
  Top = 82
  Caption = 'ACBrGTIN - Programa Exemplo'
  ClientHeight = 612
  ClientWidth = 866
  Color = clBtnFace
  ...
  object pnlCentral: TPanel
    ...
    object pgcBotoes: TPageControl
      ...
      object tsConsultas: TTabSheet
        Caption = 'Consultas'
        ImageIndex = 3
        object btnConsultarGTIN: TButton
          Left = 3
          Top = 3
          Width = 177
          Height = 25
  ...
  object ACBrGTIN1: TACBrGTIN
    OnStatusChange = ACBrGTIN1StatusChange
    OnGerarLog = ACBrGTIN1GerarLog
