...
uses
  ...
  Dialogs, IniFiles, ShellAPI, StdCtrls, Buttons, DateUtils, Spin, ExtCtrls, ComCtrls,
...
begin
  ...
  begin
    ...
    begin
      ...
      evtInfoEmpregador.infoEmpregador.infoCadastro.nrRegEtt := '';
...
//    EvtCadInicial.Versao := '2.0';
    ...
    with EvtCadInicial.Trabalhador.Dependente.Add do
    begin
      tpDep    := tdFilhoOuEnteadoAte21Anos; // tpTpDep(tdFilhoOuEnteado);
      nmDep    := 'Dependente 2';
      dtNascto := Date;
      cpfDep   := '57548758778';
      depIRRF  := tpSim;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
//Corrigir o tipo              tpDep    := tdConjuge;
              cpfDep   := '01234567898';
