...
begin
  ...
  Result.items[0]._unit := unKilogram;
  ...
  Result.items[1]._unit := unKilogram;
  ...
  Result.items[2]._unit := unKilogram;
  ...
  Result.items[3]._unit := unKilogram;
  ...
  Result.items[4]._unit := unKilogram;
  ...
  Result.items[5]._unit := unKilogram;
