...
type
  ...
  TFMain = class(TForm)
    ...
    procedure ACBrOpenDelivery1HTTPError(ALogEnvio: TACBrOpenDeliveryHTTPLogEnvio;
      ALogResposta: TACBrOpenDeliveryHTTPLogResposta;
...
begin
  ...
  ACBrOpenDelivery1.WebServices.OrderConfirm.Reason :=
    'Campo livre para mais informacoes sobre a confirmacao do pedido';
...
begin
  ...
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.deliveryPerson.id :=
    '001';
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.deliveryPerson.Name :=
    'Teste';
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.
    deliveryPerson.pictureURL := 'https:\\minhaurl.com';

  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.
    eta.deliveryEtaDatetime
  := Now;
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.
    eta.deliveryEtaInMinutes := 30;
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.eta.maxDeliveryTime :=
    IncMinute(Now, 30);

  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.event.datetime := Now;
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.event._message :=
    'Teste Msg Event';
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.event._type :=
    detDeliveryOngoing;

  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.externalTrackingURL :=
    'https:\\externaltrackingulr.com';

  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.problem.datetime
  := Now;
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.problem._message :=
    'Teste Msg Problema';
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.problem.reason :=
    prNobodyToReceive;

  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.vehiclhe.licencePlate
  :=
    'ABC1234';
  ACBrOpenDelivery1.WebServices.OrderDispatch.deliveryTrackingInfo.vehiclhe._type :=
    vtMotorBikeBag;
...
begin
  ...
  mmoOrder.Lines.Add('Total: ' +
    CurrToStr(ACBrOpenDelivery1.Order.total.orderAmount.Value));
  ...
  DM.cdsOrderorderTiming.AsString :=
    OrderTimingToStr(ACBrOpenDelivery1.Order.orderTiming);
  ...
  DM.cdsCustomerdocumentNumber.AsString :=
    ACBrOpenDelivery1.Order.customer.documentNumber;
  DM.cdsCustomername.AsString := ACBrOpenDelivery1.Order.customer.Name;
  DM.cdsCustomer.Post;

  DM.cdsOrder.Post;
  //Total
  lblItemsPriceValue.Caption :=
    CurrToStr(ACBrOpenDelivery1.Order.total.itemsPrice.Value);
  ...
  lblDeliveryPostalCode.Caption :=
    ACBrOpenDelivery1.Order.delivery.deliveryAddress.postalCode;
  lblDeliveryDistrict.Caption :=
    ACBrOpenDelivery1.Order.delivery.deliveryAddress.district;
  lblDeliveryState.Caption := ACBrOpenDelivery1.Order.delivery.deliveryAddress.state;
  lblDeliveryComplement.Caption :=
    ACBrOpenDelivery1.Order.delivery.deliveryAddress.complement;
  ...
  begin
    ...
    DM.cdsItemsspecialInstructions.AsString :=
      ACBrOpenDelivery1.Order.items[I].specialInstructions;
    DM.cdsItemsunitPriceValue.AsCurrency :=
      ACBrOpenDelivery1.Order.items[I].unitPrice.Value;
    DM.cdsItemsunitPriceCurrency.AsString :=
      ACBrOpenDelivery1.Order.items[I].unitPrice.currency;
    DM.cdsItemsoptionsPrice.AsCurrency :=
      ACBrOpenDelivery1.Order.items[I].optionsPrice.Value;
    DM.cdsItemstotalPriceValue.AsCurrency :=
      ACBrOpenDelivery1.Order.items[I].totalPrice.Value;
    DM.cdsItemstotalPriceCurrency.AsString :=
      ACBrOpenDelivery1.Order.items[I].totalPrice.currency;
  ...
  begin
    ...
    DM.cdsOptionsexternalCode.AsString :=
      ACBrOpenDelivery1.Order.items[0].options[I].externalCode;
    DM.cdsOptionsUnit.AsString := ACBrOpenDelivery1.Order.items[0].options[I]._unit;
    DM.cdsOptionsQuantity.AsFloat :=
      ACBrOpenDelivery1.Order.items[0].options[I].quantity;
    DM.cdsOptionsunitPriceValue.AsCurrency :=
      ACBrOpenDelivery1.Order.items[0].options[I].unitPrice.Value;
    DM.cdsOptionsunitPriceCurrency.AsString :=
      ACBrOpenDelivery1.Order.items[0].options[I].unitPrice.currency;
    DM.cdsOptionstotalPriceValue.AsCurrency :=
      ACBrOpenDelivery1.Order.items[0].options[I].totalPrice.Value;
    DM.cdsOptionstotalPriceCurrency.AsString :=
      ACBrOpenDelivery1.Order.items[0].options[I].totalPrice.currency;
    DM.cdsOptionsspecialInstructions.AsString :=
      ACBrOpenDelivery1.Order.items[0].options[I].specialInstructions;
  ...
  begin
    ...
    DM.cdsPaymentsmethodsValue.AsCurrency :=
      ACBrOpenDelivery1.Order.payments.methods[I].Value;
    DM.cdsPaymentsmethodsCurrency.AsString :=
      ACBrOpenDelivery1.Order.payments.methods[I].currency;
    DM.cdsPaymentsmethodsMethod.AsString :=
      PaymentMethodToStr(ACBrOpenDelivery1.Order.payments.methods[I].method);
    DM.cdsPaymentsmethodsMethodInfo.AsString :=
      ACBrOpenDelivery1.Order.payments.methods[I].methodInfo;
    DM.cdsPaymentsmethodsType.AsString :=
      PaymentTypeToStr(ACBrOpenDelivery1.Order.payments.methods[I]._type);
    DM.cdsPaymentsmethodsChangeFor.AsCurrency :=
      ACBrOpenDelivery1.Order.payments.methods[I].changeFor;
    DM.cdsPaymentsmethodsChangeValue.AsCurrency :=
      ACBrOpenDelivery1.Order.payments.methods[I].changeValue;
...
begin
  ...
  ACBrOpenDelivery1.WebServices.Acknowledgment.Events[0].OrderId :=
    edtPollingOrderId.Text;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        DM.cdsPollingeventType.AsString :=
          EventTypeToStr(ACBrOpenDelivery1.Events[I].EventType);
...
procedure TFMain.ACBrOpenDelivery1HTTPError(ALogEnvio: TACBrOpenDeliveryHTTPLogEnvio;
  ALogResposta: TACBrOpenDeliveryHTTPLogResposta; AErro: EACBrOpenDeliveryHTTPException;
