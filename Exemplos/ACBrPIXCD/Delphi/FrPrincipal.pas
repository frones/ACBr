...
uses
  ...
  ACBrOpenSSLUtils, ACBrSocket, ACBrBase, ImgList;
...
begin
  ...
  begin
    ...
    valor.original := StrToCurrDef(feCriarCobrancaImediatax_Valor.Text, 0);
...
begin
  ...
  begin
    Clear;
    valor := StrToCurrDef(feSolicitarDevolucaoPix_Valor.Text, 0);
...
begin
  mQRE.Lines.Text := ACBrPixCD1.GerarQRCodeEstatico(
    StrToCurrDef(fleQREValor.Text, 0),
