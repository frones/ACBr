...
uses
  ...
  dateutils, ACBrDFeReport, ACBrSATExtratoClass, ACBrSATExtratoReportClass,
  ACBrSATExtratoFR, ACBrIntegrador, ACBrBase, Vcl.OleCtrls, SHDocVw,  ACBrDFeSSL,
  RLFilters;
...
Uses
  math, typinfo, ACBrUtil, pcnConversao, pcnRede, synacode, IniFiles,
...
begin
    ACBrSATExtratoFR1.LarguraBobina    := seLargura.Value;
    ACBrSATExtratoFR1.MargemSuperior   := seMargemTopo.Value;
    ACBrSATExtratoFR1.MargemInferior   := seMargemFundo.Value;
    ACBrSATExtratoFR1.MargemEsquerda   := seMargemEsquerda.Value;
    ACBrSATExtratoFR1.MargemDireita    := seMargemDireita.Value;
    ACBrSATExtratoFR1.MostraPreview   := cbPreview.Checked;

    try
      if lImpressora.Caption <> '' then
        ACBrSATExtratoFR1.Impressora := lImpressora.Caption;
    except
    end;
