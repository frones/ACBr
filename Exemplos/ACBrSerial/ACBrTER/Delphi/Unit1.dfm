object Form1: TForm1
  ...
  object btnEnviaMensagem: TButton
    Left = 4
    Top = 116
    Width = 89
    Height = 25
    ...
    TabOrder = 0
    OnClick = btnEnviaMensagemClick
  end
  object btnLimpaDisplay: TButton
    Left = 4
    Top = 152
    Width = 89
    Height = 25
  ...
  object Panel1: TPanel
    ...
    object Label7: TLabel
      ...
      Width = 203
      Height = 13
      Caption = '* Modelo testado : Wilbor RS485 (Term16) '
    end
    object Label8: TLabel
      ...
      Width = 171
      Height = 13
      Caption = '* Testes efetuados com comutadora'
    end
  end
  object Button1: TButton
    ...
    Width = 89
    Height = 25
    Caption = 'Posiciona Cursor'
    TabOrder = 14
    OnClick = Button1Click
  end
  object cbxLinha: TSpinEdit
    Left = 96
    Top = 192
    Width = 41
    Height = 22
