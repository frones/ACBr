  ...
  /// Printer class for Sunmi Printer
   ...
   TACBrSunmiPrinter = Class(TComponent)
    ...
    Function sendRAWData(data: TBytes): TACBrSunmiPrinter;
         ...
         ///   fontsize = tamanho
         /// </summary>
         Function printTextWithFont(text: String; Typeface : String; fontsize : Single) : TACBrSunmiPrinter;
         /// <summary>
         ...
         /// </summary>
         Function printColumnsText(colsTextArr : Array of String; colsWidthArr : Array Of Integer; colsAlign : Array Of Integer) : TACBrSunmiPrinter;
         /// <summary>
         ...
         /// </summary>
         Function printBarCode(data : String; symbology : Integer = 2; height : Integer = 96; width : Integer = 2; textposition : Integer = 2) : TACBrSunmiPrinter;
         /// <summary>
         ///   Imprime QRCode
         ...
         /// </summary>
         Function printQRCode(data : String; modulesize : Integer = 4; errorlevel : Integer = 1) : TACBrSunmiPrinter;
         /// <summary>
...
function TACBrSunmiPrinter.enterPrinterBuffer(clean: Boolean): TACBrSunmiPrinter;
begin
Result := Self;
{$IFDEF ANDROID}
...
function TACBrSunmiPrinter.exitPrinterBuffer(commit: Boolean): TACBrSunmiPrinter;
begin
Result := Self;
{$IFDEF ANDROID}
...
function TACBrSunmiPrinter.printBarCode(data: String; symbology : Integer = 2; height : Integer = 96; width : Integer = 2; textposition : Integer = 2) : TACBrSunmiPrinter;
begin
Result := Self;
{$IFDEF ANDROID}
FPrinter.printBarCode(StringToJstring(data), symbology, height, width, textposition);
{$ENDIF}
end;
...
function TACBrSunmiPrinter.printColumnsText(colsTextArr: array of String; colsWidthArr, colsAlign: array of Integer): TACBrSunmiPrinter;
{$IFDEF ANDROID}
Var
   i : Integer;
   S : array of JString;
...
function TACBrSunmiPrinter.printQRCode(data: String; modulesize : Integer = 4; errorlevel : Integer = 1) : TACBrSunmiPrinter;
begin
Result := Self;
{$IFDEF ANDROID}
...
function TACBrSunmiPrinter.printTextWithFont(text, Typeface: String; fontsize: Single): TACBrSunmiPrinter;
begin
Result := Self;
{$IFDEF ANDROID}
FPrinter.printTextWithFont(StringToJString(text), StringToJString(Typeface), fontsize);
{$ENDIF}
end;
