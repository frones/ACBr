...
Type
   ...
   [JavaSignature('com/acbr/secondDisplay/SecondScreen')]
   ...
   JStateLedsClass   = Interface(JObjectClass)
      ...
      End;
   [JavaSignature('com/acbr/leds/Leds')]
   JStateLeds        = interface(JObject)
      ['{CDFB063F-3690-4DDA-8B22-3B402EE6F1DB}']
      Procedure controlLamp(status : Integer; lamp : JString); cdecl;
      Procedure controlLampForLoop(status : Integer; lightTime, putoutTime : LongInt; lamp : JString); cdecl;
      Procedure closeAllLamp; cdecl;
      end;
   TJStateLeds       = class(TJavaGenericImport<JStateLedsClass, JStateLeds>) end;
   ...
   JVideoPlayerClass   = Interface(JObjectClass)
      ...
      End;
   [JavaSignature('com/acbr/play/VideoPlayer')]
   ...
   TJVideoPlayer       = class(TJavaGenericImport<JVideoPlayerClass, JVideoPlayer>) end;
   ...
   [JavaSignature('com/acbr/sunmiprinter/SunmiPrinter')]
   ...
   TJSunmiPrinter = class(TJavaGenericImport<JSunmiPrinterClass, JSunmiPrinter>) end;
{$ENDIF}
