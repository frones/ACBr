...
type
  ...
  TACBrBancoUniprime = class(TACBrBancoClass)
  private
  protected
  public
...
constructor TACBrBancoUniprime.create(AOwner: TACBrBanco);
begin
...
function TACBrBancoUniprime.CalcularDigitoVerificador(const ACBrTitulo: TACBrTitulo ): String;
begin
...
function TACBrBancoUniprime.MontarCodigoBarras ( const ACBrTitulo: TACBrTitulo) : String;
var
...
function TACBrBancoUniprime.MontarCampoNossoNumero (
   const ACBrTitulo: TACBrTitulo ) : String;
begin
   Result:= ACBrTitulo.Carteira+'/'+ACBrTitulo.NossoNumero+'-'+CalcularDigitoVerificador(ACBrTitulo);
end;

function TACBrBancoUniprime.MontarCampoCodigoCedente (
   const ACBrTitulo: TACBrTitulo ) : String;
begin
...
procedure TACBrBancoUniprime.GerarRegistroHeader400(NumeroRemessa : Integer; ARemessa:TStringList);
var
  wLinha: String;
begin
...
procedure TACBrBancoUniprime.GerarRegistroTransacao400(ACBrTitulo :TACBrTitulo; aRemessa: TStringList);
var
...
procedure TACBrBancoUniprime.GerarRegistroTrailler400( ARemessa:TStringList );
var
  wLinha: String;
begin
...
Procedure TACBrBancoUniprime.LerRetorno400 ( ARetorno: TStringList );
var
  Titulo : TACBrTitulo;
...
function TACBrBancoUniprime.TipoOcorrenciaToDescricao(const TipoOcorrencia: TACBrTipoOcorrencia): String;
var
...
function TACBrBancoUniprime.CodOcorrenciaToTipo(const CodOcorrencia:
...
function TACBrBancoUniprime.TipoOcorrenciaToCod ( const TipoOcorrencia: TACBrTipoOcorrencia ) : String;
begin
  Result := '';
...
function TACBrBancoUniprime.CodMotivoRejeicaoToDescricao( const TipoOcorrencia:TACBrTipoOcorrencia ;CodMotivo: Integer) : String;
begin
   case TipoOcorrencia of
...
procedure TACBrBancoUniprime.LerRetorno240(ARetorno: TStringList);
var
  Titulo: TACBrTitulo;
...
function TACBrBancoUniprime.CodOcorrenciaToTipoRemessa(const CodOcorrencia:Integer): TACBrTipoOcorrencia;
begin
  case CodOcorrencia of
