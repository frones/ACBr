...
procedure TBPeIniReader.Ler_gIBSUF(AINIRec: TMemIniFile; gIBSUF: TgIBSValores; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
  if Idx1 = -1 then
...
procedure TBPeIniReader.Ler_gIBSMun(AINIRec: TMemIniFile; gIBSMun: TgIBSValores; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
  if Idx1 = -1 then
