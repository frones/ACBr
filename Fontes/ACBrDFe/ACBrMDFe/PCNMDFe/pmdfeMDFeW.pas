...
uses
  SysUtils, Classes,
  pcnAuxiliar, pcnConversao, pcnGerador, synacode,
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Gerador.wCampo(tcStr, '#27', 'nCompra' , 01, 20, 1, MDFe.Rodo.infANTT.valePed.disp[i].nCompra, DSC_NCOMPRA);
...
function TMDFeW.CalcularHashCSRT(ACSRT, AChave: String): string;
begin
