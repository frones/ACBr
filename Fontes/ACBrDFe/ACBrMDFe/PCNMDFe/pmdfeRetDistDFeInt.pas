...
//                                                                            //
//   Descrição: Classes para geração/leitura dos arquivos xml da MDFe         //
//                                                                            //
...
//              "PCN  -  Projeto  Cooperar  MDFe", não  podendo o mesmo ser   //
      ...
      begin
        ...
        try
          ...
          begin
            ...
            FdocZip.Items[i].FresMDFe.FxNome := ParseText(oLeitorInfZip.rCampo(tcStr, 'xNome'));
