...
procedure TNF3eXmlReader.Ler_gIBSUF_gTribRegular(const ANode: TACBrXmlNode;
...
procedure TNF3eXmlReader.Ler_gIBSMun_gDif(const ANode: TACBrXmlNode; gDif: TgDifCBS);
begin
  if not Assigned(ANode) then Exit;
...
procedure TNF3eXmlReader.Ler_gIBSMun_gTribRegular(const ANode: TACBrXmlNode;
  gTribRegular: TgTribRegular);
begin
  if not Assigned(ANode) then Exit;
...
procedure TNF3eXmlReader.Ler_gCBS_gDif(const ANode: TACBrXmlNode; gDif: TgDifCBS);
begin
  if not Assigned(ANode) then Exit;
...
procedure TNF3eXmlReader.Ler_gCBS_gTribRegular(const ANode: TACBrXmlNode;
  gTribRegular: TgTribRegular);
begin
  if not Assigned(ANode) then Exit;
