inherited frmNF3eDAEventoRLRetrato: TfrmNF3eDAEventoRLRetrato
  Left = 274
  Top = 83
  ...
  Font.Style = [fsBold]
  TextHeight = 10
  inherited RLNF3eEvento: TRLReport
    Left = 0
    Top = 0
    ...
    object rlb_04_Destinatario: TRLBand
      ...
      Color = clWhite
      ParentColor = False
      BeforePrint = rlb_04_DestinatarioBeforePrint
      ...
      object rllRazaoDestinatario: TRLLabel
        Left = 4
        Top = 30
        Width = 98
        Height = 14
      ...
      object rllEnderecoDestinatario: TRLLabel
        Left = 4
        Top = 62
        Width = 113
        Height = 14
      ...
      object rllMunDestinatario: TRLLabel
        Left = 4
        Top = 94
        Width = 91
        Height = 14
      ...
      object rllCNPJDestinatario: TRLLabel
        Left = 608
        Top = 30
        Width = 96
        Height = 14
      ...
      object rllBairroDestinatario: TRLLabel
        Left = 452
        Top = 62
        Width = 99
        Height = 14
      ...
      object rllCEPDestinatario: TRLLabel
        Left = 669
        Top = 62
        Width = 64
        Height = 15
      ...
      object rllFoneDestinatario: TRLLabel
        Left = 452
        Top = 94
        Width = 93
        Height = 14
      ...
      object rllInscEstDestinatario: TRLLabel
        Left = 624
        Top = 94
        Width = 104
        Height = 14
    ...
    object rlb_02_Documento: TRLBand
      ...
      object rlLabel65: TRLLabel
        ...
        Width = 313
        Height = 13
        Caption = 'NOTA FISCAL DE COMUNICA'#199#195'O/TELECOMUNICA'#199#195'O'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
