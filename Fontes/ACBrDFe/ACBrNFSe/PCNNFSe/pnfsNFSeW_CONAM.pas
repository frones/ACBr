...
begin
  ...
  Gerador.wCampoNFSe(tcStr, '', 'Ano', 001, 4, 0, FormatDateTime('yyyy', FNFSe.DataEmissaoRps) , '');
  Gerador.wCampoNFSe(tcStr, '', 'Mes', 001, 2, 0, FormatDateTime('mm', FNFSe.DataEmissaoRps) , '');
  Gerador.wCampoNFSe(tcStr, '', 'CPFCNPJ', 001, 14, 0, FNFSe.Prestador.Cnpj , '');
  Gerador.wCampoNFSe(tcStr, '', 'DTIni', 001, 10, 0, FormatDateTime('dd/mm/yyyy', FNFSe.DataEmissaoRps) , '');
  Gerador.wCampoNFSe(tcStr, '', 'DTFin', 001, 10, 0, FormatDateTime('dd/mm/yyyy', FNFSe.DataEmissaoRps) , '');
