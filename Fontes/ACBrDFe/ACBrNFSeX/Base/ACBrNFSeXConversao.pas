...
type
  ...
  TnfseProvedor = (proNenhum,
                   ...
                   proPriMax, proProdata, proPRODAUB, proPronim, proPublica,
                   proPublicSoft, proRLZ, proSam, proSaatri, proSafeWeb, proSH3,
                   proSiam, proSiapNet, proSiappa, proSiapSistemas, proSiat,
                   proSigCorp, proSigep, proSigISS, proSigISSWeb, proSilTecnologia,
