...
type
  TACBrNFSeXWebserviceGestaoISS202 = class(TACBrNFSeXWebserviceSoap11)
  public
  ...
  TACBrNFSeProviderGestaoISS202 = class (TACBrNFSeProviderABRASFv2)
  protected
...
uses
  ACBrUtil.XMLHTML,
  ACBrDFeException,
  GestaoISS.GravarXml, GestaoISS.LerXml;

{ TACBrNFSeProviderGestaoISS202 }

procedure TACBrNFSeProviderGestaoISS202.Configuracao;
begin
...
function TACBrNFSeProviderGestaoISS202.CriarGeradorXml(
  const ANFSe: TNFSe): TNFSeWClass;
begin
  Result := TNFSeW_GestaoISS202.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderGestaoISS202.CriarLeitorXml(
  const ANFSe: TNFSe): TNFSeRClass;
begin
  Result := TNFSeR_GestaoISS202.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderGestaoISS202.CriarServiceClient(
...
begin
  ...
  if URL <> '' then
    Result := TACBrNFSeXWebserviceGestaoISS202.Create(FAOwner, AMetodo, URL)
  else
  begin
...
{ TACBrNFSeXWebserviceGestaoISS202 }

function TACBrNFSeXWebserviceGestaoISS202.Recepcionar(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.RecepcionarSincrono(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.GerarNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.ConsultarLote(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.ConsultarNFSePorFaixa(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.ConsultarNFSePorRps(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.ConsultarNFSeServicoPrestado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.ConsultarNFSeServicoTomado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.Cancelar(const ACabecalho, AMSG: String): string;
var
  Request: string;
begin
  FPMsgOrig := AMSG;
...
function TACBrNFSeXWebserviceGestaoISS202.SubstituirNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceGestaoISS202.TratarXmlRetornado(
