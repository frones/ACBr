...
type
  TACBrNFSeXWebserviceISSLegal203 = class(TACBrNFSeXWebserviceSoap11)
  protected
  ...
  TACBrNFSeProviderISSLegal203 = class (TACBrNFSeProviderABRASFv2)
  protected
...
uses
  ...
  ISSLegal.GravarXml, ISSLegal.LerXml;

{ TACBrNFSeProviderISSLegal203 }
...
function TACBrNFSeProviderISSLegal203.CriarGeradorXml(
  const ANFSe: TNFSe): TNFSeWClass;
begin
  Result := TNFSeW_ISSLegal203.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderISSLegal203.CriarLeitorXml(
  const ANFSe: TNFSe): TNFSeRClass;
begin
  Result := TNFSeR_ISSLegal203.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderISSLegal203.CriarServiceClient(
...
begin
  ...
  if URL <> '' then
    Result := TACBrNFSeXWebserviceISSLegal203.Create(FAOwner, AMetodo, URL)
  else
  begin
...
{ TACBrNFSeXWebserviceISSLegal203 }

procedure TACBrNFSeXWebserviceISSLegal203.SetHeaders(aHeaderReq: THTTPHeader);
begin
  aHeaderReq.AddHeader('Authorization',
             TConfiguracoesNFSe(FPConfiguracoes).Geral.Emitente.WSChaveAutoriz);
end;

function TACBrNFSeXWebserviceISSLegal203.Recepcionar(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.RecepcionarSincrono(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.GerarNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.ConsultarLote(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.ConsultarNFSePorFaixa(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.ConsultarNFSePorRps(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.ConsultarNFSeServicoPrestado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.ConsultarNFSeServicoTomado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.Cancelar(const ACabecalho, AMSG: String): string;
var
  Request: string;
begin
  FPMsgOrig := AMSG;
...
function TACBrNFSeXWebserviceISSLegal203.SubstituirNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSLegal203.TratarXmlRetornado(
