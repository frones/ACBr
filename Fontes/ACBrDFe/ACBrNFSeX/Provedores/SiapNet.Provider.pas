...
type
  TACBrNFSeXWebserviceSiapNet200 = class(TACBrNFSeXWebserviceSoap11)
  public
  ...
  TACBrNFSeProviderSiapNet200 = class (TACBrNFSeProviderABRASFv2)
  protected
...
procedure TACBrNFSeProviderSiapNet200.Configuracao;
begin
...
function TACBrNFSeProviderSiapNet200.CriarGeradorXml(
  const ANFSe: TNFSe): TNFSeWClass;
begin
  Result := TNFSeW_SiapNet200.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderSiapNet200.CriarLeitorXml(
  const ANFSe: TNFSe): TNFSeRClass;
begin
  Result := TNFSeR_SiapNet200.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderSiapNet200.CriarServiceClient(
...
begin
  ...
  if URL <> '' then
    Result := TACBrNFSeXWebserviceSiapNet200.Create(FAOwner, AMetodo, URL)
  else
  begin
...
{ TACBrNFSeXWebserviceSiapNet200 }

function TACBrNFSeXWebserviceSiapNet200.Recepcionar(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.RecepcionarSincrono(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.GerarNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.ConsultarLote(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.ConsultarNFSePorFaixa(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.ConsultarNFSePorRps(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.ConsultarNFSeServicoPrestado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.ConsultarNFSeServicoTomado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.Cancelar(const ACabecalho, AMSG: String): string;
var
  Request: string;
begin
  FPMsgOrig := AMSG;
...
function TACBrNFSeXWebserviceSiapNet200.SubstituirNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceSiapNet200.TratarXmlRetornado(
