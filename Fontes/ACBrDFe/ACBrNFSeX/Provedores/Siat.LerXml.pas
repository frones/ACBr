...
procedure TNFSeR_Siat.LerDeducoes(const ANode: TACBrXmlNode);
var
...
procedure TNFSeR_Siat.LerItens(const ANode: TACBrXmlNode);
var
  AuxNode: TACBrXmlNode;
  ANodes: TACBrXmlNodeArray;
  i: Integer;
...
function TNFSeR_Siat.LerXml: Boolean;
var
...
function TNFSeR_Siat.LerXmlNfse(const ANode: TACBrXmlNode): Boolean;
var
  AuxNode: TACBrXmlNode;
  aValor: string;
  Ok :Boolean;
...
function TNFSeR_Siat.LerXmlRps(const ANode: TACBrXmlNode): Boolean;
var
  aValor: string;
begin
  Result := True;
