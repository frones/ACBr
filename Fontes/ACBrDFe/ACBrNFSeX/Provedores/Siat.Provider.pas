...
type
  ...
  TACBrNFSeProviderSiat = class (TACBrNFSeProviderProprio)
  protected
...
procedure TACBrNFSeProviderSiat.AssinaturaAdicional(Nota: NotaFiscal);
var
   ...
   with ConfigWebServices.Homologacao do
    begin
      case AMetodo of
        ...
        tmConsultarSituacao:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, ConsultarSituacao);
        tmConsultarLote:
        ...
        tmConsultarNFSeURL:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, ConsultarNFSeURL);
        tmConsultarNFSePorFaixa:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, ConsultarNFSePorFaixa);
        tmConsultarNFSeServicoPrestado:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, ConsultarNFSeServicoPrestado);
        tmConsultarNFSeServicoTomado:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, ConsultarNFSeServicoTomado);
        tmCancelarNFSe:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, CancelarNFSe);
        tmGerar:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, GerarNFSe);
        tmRecepcionarSincrono:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, RecepcionarSincrono);
        tmSubstituirNFSe:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, SubstituirNFSe);
        tmAbrirSessao:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, AbrirSessao);
        tmFecharSessao:
          Result := TACBrNFSeXWebserviceSiat.Create(FAOwner, AMetodo, FecharSessao);
      else
        // tmTeste
...
procedure TACBrNFSeProviderSiat.PrepararEmitir(Response: TNFSeEmiteResponse);
var
  AErro: TNFSeEventoCollectionItem;
...
procedure TACBrNFSeProviderSiat.TratarRetornoEmitir(Response: TNFSeEmiteResponse);
var
...
procedure TACBrNFSeProviderSiat.PrepararConsultaLoteRps(
...
procedure TACBrNFSeProviderSiat.TratarRetornoConsultaLoteRps(
  Response: TNFSeConsultaLoteRpsResponse);
var
  Document: TACBrXmlDocument;
  AErro: TNFSeEventoCollectionItem;
...
procedure TACBrNFSeProviderSiat.PrepararConsultaNFSeporRps(
...
procedure TACBrNFSeProviderSiat.TratarRetornoConsultaNFSeporRps(
  Response: TNFSeConsultaNFSeporRpsResponse);
var
  Document: TACBrXmlDocument;
  AErro: TNFSeEventoCollectionItem;
...
procedure TACBrNFSeProviderSiat.PrepararConsultaNFSe(
...
begin
  ...
  begin
    AErro := Response.Erros.New;
    AErro.Codigo := '999';
    AErro.Descricao := 'Data Inicial não informada.';
    Exit;
  end;
  ...
  begin
    AErro := Response.Erros.New;
    AErro.Codigo := '999';
    AErro.Descricao := 'Data Final não informada.';
    Exit;
  end;
  ...
  begin
    AErro := Response.Erros.New;
    AErro.Codigo := '999';
    AErro.Descricao := 'Numero do Lote não informado.';
    Exit;
  end;
...
procedure TACBrNFSeProviderSiat.TratarRetornoConsultaNFSe(
  Response: TNFSeConsultaNFSeResponse);
var
  Document: TACBrXmlDocument;
  AErro: TNFSeEventoCollectionItem;
...
procedure TACBrNFSeProviderSiat.PrepararCancelaNFSe(
...
procedure TACBrNFSeProviderSiat.TratarRetornoCancelaNFSe(
  Response: TNFSeCancelaNFSeResponse);
var
  Document: TACBrXmlDocument;
  AErro: TNFSeEventoCollectionItem;
