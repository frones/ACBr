...
type
  ...
  TNFSeR_Smart4 = class(TNFSeRClass)
  private
...
procedure TNFSeR_Smart4.LerInformacoesCancelamento(const ANode: TACBrXmlNode);
var
...
function TNFSeR_Smart4.LerXml: Boolean;
var
...
function TNFSeR_Smart4.LerXmlNfse(const ANode: TACBrXmlNode): Boolean;
var
...
function TNFSeR_Smart4.LerXmlRps(const ANode: TACBrXmlNode): Boolean;
var
  AuxNode: TACBrXmlNode;
  ANodes: TACBrXmlNodeArray;
  i: Integer;
