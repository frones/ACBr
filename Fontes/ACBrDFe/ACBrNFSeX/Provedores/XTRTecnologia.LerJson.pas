...
type
  ...
  { TNFSeR_XTRTecnologia }

  TNFSeR_XTRTecnologia = class(TNFSeRClass)
  protected
...
function TNFSeR_XTRTecnologia.LerXml: Boolean;
begin
...
function TNFSeR_XTRTecnologia.LerJsonNfse(const ArquivoRetorno: String): Boolean;
var
...
function TNFSeR_XTRTecnologia.LerJsonRps(const ArquivoRetorno: String): Boolean;
var
  jsRet: TACBrJSONObject;
begin
  Result := False;
...
procedure TNFSeR_XTRTecnologia.LerRps(aJson: TACBrJSONObject);
var
...
procedure TNFSeR_XTRTecnologia.LerNota(aJson: TACBrJSONObject; FRps: Boolean);
var
  jsAux: TACBrJSONObject;
  OK: Boolean;
begin
...
procedure TNFSeR_XTRTecnologia.LerSituacaoNfse(aJson: TACBrJSONObject);
var
  jsAux: TACBrJSONObject;
begin
...
procedure TNFSeR_XTRTecnologia.LerIdentificacaoPrestador(aJson: TACBrJSONObject);
var
  jsAux: TACBrJSONObject;
begin
...
procedure TNFSeR_XTRTecnologia.LerPrestador(aJson: TACBrJSONObject);
var
  jsAux: TACBrJSONObject;
begin
  jsAux := aJson.AsJSONObject['Prestador'];
...
procedure TNFSeR_XTRTecnologia.LerTomador(aJson: TACBrJSONObject);
var
  jsAux: TACBrJSONObject;
  aValor: string;
begin
...
procedure TNFSeR_XTRTecnologia.LerEndereco(aJson: TACBrJSONObject; aEndereco: TEndereco);
var
  jsAux: TACBrJSONObject;
  xUF: string;
begin
...
procedure TNFSeR_XTRTecnologia.LerContato(aJson: TACBrJSONObject; aContato: TContato);
var
  jsAux: TACBrJSONObject;
begin
...
procedure TNFSeR_XTRTecnologia.LerServicos(aJson: TACBrJSONObject);
var
  jsAux: TACBrJSONObject;
