...
begin
  ...
  begin
    ...
    LoadLayout('<GA>     GA|');
    LoadLayout('<GA>   GA02|CNPJ¨');
    LoadLayout('<GA>   GA03|CPF¨');
    ...
    LoadLayout('<I01>  I05a|NVE¨');
    LoadLayout('<I01>  I05c|CEST¨');
    ...
    LoadLayout('<N10h> N10h|Orig¨|CSOSN¨|modBC¨|vBC¨|pRedBC¨|pICMS¨|vICMS¨|modBCST¨|pMVAST¨|pRedBCST¨|vBCST¨|pICMSST¨|vICMSST¨|pCredSN¨|vCredICMSSN¨');
    LoadLayout('<NA01>   NA|vBCUFDest¨|pFCPUFDest¨|pICMSUFDest¨|pICMSInter¨|pICMSInterPart¨|vFCPUFDest¨|vICMSUFRemet¨|vICMSUFDest¨'); //Invertidos campos remet e dest até a receita corrigir a importação do txt (ou permanentemente, se isso não acontecer).
