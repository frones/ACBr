...
unit PagFor.Banrisul.LerTxtRetorno;
...
type
 { TArquivoR_Banrisul }
  ...
  TArquivoR_Banrisul = class(TArquivoR_CNAB240)
  protected
...
procedure TArquivoR_Banrisul.LerSegmentoA(nLinha: Integer);
var
  mOk: Boolean;
  RegSeg: string;
  x: Integer;
begin
  ...
  begin
    ...
    Favorecido.Nome := LerCampo(Linha, 44, 30, tcStr);
...
procedure TArquivoR_Banrisul.LerSegmentoB(mSegmentoBList: TSegmentoBList;
  nLinha: Integer);
var
  mOk: Boolean;
  RegSeg: string;
begin
  ...
  begin
    ...
    begin
      ...
      PixMensagem := LerCampo(Linha, 68, 60, tcStr);
      PixChave := LerCampo(Linha, 128, 99, tcStr);
...
procedure TArquivoR_Banrisul.LerSegmentoG(nLinha: Integer);
var
  mOk: Boolean;
  RegSeg: string;
begin
...
procedure TArquivoR_Banrisul.LerSegmentoH(mSegmentoHList: TSegmentoHList;
  nLinha: Integer);
var
  mOk: Boolean;
  RegSeg: string;
