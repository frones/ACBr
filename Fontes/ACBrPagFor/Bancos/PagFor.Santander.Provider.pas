...
unit PagFor.Santander.Provider;
...
type
  ...
  TACBrPagForProviderSantander = class (TCNAB240Provider)
  protected
...
{ TACBrPagForProviderSantander }

function TACBrPagForProviderSantander.CriarGeradorTxt(
...
function TACBrPagForProviderSantander.CriarLeitorTxt(
