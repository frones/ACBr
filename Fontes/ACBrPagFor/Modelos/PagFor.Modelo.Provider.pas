...
type
  ...
  TACBrPagForProviderModelo = class (TCNAB240Provider)
  protected
...
uses
  PagFor.Modelo.GravarTxtRemessa, PagFor.Modelo.LerTxtRetorno;

{ TACBrPagForProviderModelo }

procedure TACBrPagForProviderModelo.Configuracao;
begin
  inherited Configuracao;

end;

function TACBrPagForProviderModelo.CriarGeradorTxt(
...
function TACBrPagForProviderModelo.CriarLeitorTxt(
