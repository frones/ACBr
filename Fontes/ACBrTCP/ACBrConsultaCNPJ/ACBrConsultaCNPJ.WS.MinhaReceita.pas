...
{                                                                              }
{ Colaboradores nesse arquivo: leootoni, Rentato Rubinho                       }
{                                                                              }
...
{$I ACBr.inc}
unit ACBrConsultaCNPJ.WS.MinhaReceita;
...
type
  ...
  { TACBrConsultaCNPJWS }
  TACBrConsultaCNPJWSMinhaReceita = class(TACBrConsultaCNPJWS)
  public
    function Executar:boolean; override;
  end;

const
  C_URL = 'https://minhareceita.org/';
...
function TACBrConsultaCNPJWSMinhaReceita.Executar: boolean;
var
