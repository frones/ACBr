...
begin
  ...
  begin
     ...
     begin
        ...
        WriteRegistroC595( RegC001.RegistroC500.Items[intFor] ) ;
...
begin
  ...
  begin
    Add( LFill('C815') +
         ...
         VLFill( VL_UNIT_ICMS_ST_CONV_REST, 6 ) +
         VLFill( VL_UNIT_FCP_ST_CONV_REST, 6 ) +
         VLFill( VL_UNIT_ICMS_ST_CONV_COMPL, 6 ) +
         VLFill( VL_UNIT_FCP_ST_CONV_COMPL, 6 )
       ) ;
  end;
