...
begin
  TRegTypes.RegisterType('G720Interface.JAnimator', TypeInfo(G720Interface.JAnimator));
  TRegTypes.RegisterType('G720Interface.JAnimator_AnimatorListener', TypeInfo(G720Interface.JAnimator_AnimatorListener));
  TRegTypes.RegisterType('G720Interface.JAnimator_AnimatorPauseListener', TypeInfo(G720Interface.JAnimator_AnimatorPauseListener));
  TRegTypes.RegisterType('G720Interface.JKeyframe', TypeInfo(G720Interface.JKeyframe));
  TRegTypes.RegisterType('G720Interface.JLayoutTransition', TypeInfo(G720Interface.JLayoutTransition));
  TRegTypes.RegisterType('G720Interface.JLayoutTransition_TransitionListener', TypeInfo(G720Interface.JLayoutTransition_TransitionListener));
  TRegTypes.RegisterType('G720Interface.JPropertyValuesHolder', TypeInfo(G720Interface.JPropertyValuesHolder));
  TRegTypes.RegisterType('G720Interface.JStateListAnimator', TypeInfo(G720Interface.JStateListAnimator));
  TRegTypes.RegisterType('G720Interface.JTimeInterpolator', TypeInfo(G720Interface.JTimeInterpolator));
  TRegTypes.RegisterType('G720Interface.JTypeConverter', TypeInfo(G720Interface.JTypeConverter));
  TRegTypes.RegisterType('G720Interface.JTypeEvaluator', TypeInfo(G720Interface.JTypeEvaluator));
  TRegTypes.RegisterType('G720Interface.JValueAnimator', TypeInfo(G720Interface.JValueAnimator));
  TRegTypes.RegisterType('G720Interface.JValueAnimator_AnimatorUpdateListener', TypeInfo(G720Interface.JValueAnimator_AnimatorUpdateListener));
  TRegTypes.RegisterType('G720Interface.JPathMotion', TypeInfo(G720Interface.JPathMotion));
  TRegTypes.RegisterType('G720Interface.JScene', TypeInfo(G720Interface.JScene));
  TRegTypes.RegisterType('G720Interface.JTransition', TypeInfo(G720Interface.JTransition));
  TRegTypes.RegisterType('G720Interface.JTransition_EpicenterCallback', TypeInfo(G720Interface.JTransition_EpicenterCallback));
  TRegTypes.RegisterType('G720Interface.JTransition_TransitionListener', TypeInfo(G720Interface.JTransition_TransitionListener));
  TRegTypes.RegisterType('G720Interface.JTransitionManager', TypeInfo(G720Interface.JTransitionManager));
  TRegTypes.RegisterType('G720Interface.JTransitionPropagation', TypeInfo(G720Interface.JTransitionPropagation));
  TRegTypes.RegisterType('G720Interface.JTransitionValues', TypeInfo(G720Interface.JTransitionValues));
  TRegTypes.RegisterType('G720Interface.JInterpolator', TypeInfo(G720Interface.JInterpolator));
  TRegTypes.RegisterType('G720Interface.JToolbar_LayoutParams', TypeInfo(G720Interface.JToolbar_LayoutParams));
  TRegTypes.RegisterType('G720Interface.Jgertec_Logger', TypeInfo(G720Interface.Jgertec_Logger));
  TRegTypes.RegisterType('G720Interface.Jgertec_a_a', TypeInfo(G720Interface.Jgertec_a_a));
  TRegTypes.RegisterType('G720Interface.Jgertec_a_a_a', TypeInfo(G720Interface.Jgertec_a_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_a_a_a', TypeInfo(G720Interface.Ja_a_a_a));
  TRegTypes.RegisterType('G720Interface.JIGEDI', TypeInfo(G720Interface.JIGEDI));
  TRegTypes.RegisterType('G720Interface.JGEDI', TypeInfo(G720Interface.JGEDI));
  TRegTypes.RegisterType('G720Interface.JGEDI_1', TypeInfo(G720Interface.JGEDI_1));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_Control_Callbacks', TypeInfo(G720Interface.JGEDI_KMS_st_Control_Callbacks));
  TRegTypes.RegisterType('G720Interface.JGediNative', TypeInfo(G720Interface.JGediNative));
  TRegTypes.RegisterType('G720Interface.JICL', TypeInfo(G720Interface.JICL));
  TRegTypes.RegisterType('G720Interface.Jgedi_a', TypeInfo(G720Interface.Jgedi_a));
  TRegTypes.RegisterType('G720Interface.JIAUDIO', TypeInfo(G720Interface.JIAUDIO));
  TRegTypes.RegisterType('G720Interface.Jgedi_a_a', TypeInfo(G720Interface.Jgedi_a_a));
  TRegTypes.RegisterType('G720Interface.Jgedi_a_b', TypeInfo(G720Interface.Jgedi_a_b));
  TRegTypes.RegisterType('G720Interface.JICLOCK', TypeInfo(G720Interface.JICLOCK));
  TRegTypes.RegisterType('G720Interface.Jgedi_b', TypeInfo(G720Interface.Jgedi_b));
  TRegTypes.RegisterType('G720Interface.Jgedi_a_c', TypeInfo(G720Interface.Jgedi_a_c));
  TRegTypes.RegisterType('G720Interface.JICRYPT', TypeInfo(G720Interface.JICRYPT));
  TRegTypes.RegisterType('G720Interface.Jgedi_c', TypeInfo(G720Interface.Jgedi_c));
  TRegTypes.RegisterType('G720Interface.Jgedi_a_d', TypeInfo(G720Interface.Jgedi_a_d));
  TRegTypes.RegisterType('G720Interface.Jgedi_a_e', TypeInfo(G720Interface.Jgedi_a_e));
  TRegTypes.RegisterType('G720Interface.JIINFO', TypeInfo(G720Interface.JIINFO));
  TRegTypes.RegisterType('G720Interface.Jgedi_d', TypeInfo(G720Interface.Jgedi_d));
  TRegTypes.RegisterType('G720Interface.Ja_f', TypeInfo(G720Interface.Ja_f));
  TRegTypes.RegisterType('G720Interface.Jf_1', TypeInfo(G720Interface.Jf_1));
  TRegTypes.RegisterType('G720Interface.JIKBD', TypeInfo(G720Interface.JIKBD));
  TRegTypes.RegisterType('G720Interface.Jgedi_e', TypeInfo(G720Interface.Jgedi_e));
  TRegTypes.RegisterType('G720Interface.Ja_g', TypeInfo(G720Interface.Ja_g));
  TRegTypes.RegisterType('G720Interface.Jg_1', TypeInfo(G720Interface.Jg_1));
  TRegTypes.RegisterType('G720Interface.Jg_10', TypeInfo(G720Interface.Jg_10));
  TRegTypes.RegisterType('G720Interface.Jg_11', TypeInfo(G720Interface.Jg_11));
  TRegTypes.RegisterType('G720Interface.Jg_12', TypeInfo(G720Interface.Jg_12));
  TRegTypes.RegisterType('G720Interface.Jg_13', TypeInfo(G720Interface.Jg_13));
  TRegTypes.RegisterType('G720Interface.Jg_2', TypeInfo(G720Interface.Jg_2));
  TRegTypes.RegisterType('G720Interface.Jg_3', TypeInfo(G720Interface.Jg_3));
  TRegTypes.RegisterType('G720Interface.Jg_4', TypeInfo(G720Interface.Jg_4));
  TRegTypes.RegisterType('G720Interface.Jg_5', TypeInfo(G720Interface.Jg_5));
  TRegTypes.RegisterType('G720Interface.Jg_6', TypeInfo(G720Interface.Jg_6));
  TRegTypes.RegisterType('G720Interface.Jg_7', TypeInfo(G720Interface.Jg_7));
  TRegTypes.RegisterType('G720Interface.Jg_8', TypeInfo(G720Interface.Jg_8));
  TRegTypes.RegisterType('G720Interface.Jg_9', TypeInfo(G720Interface.Jg_9));
  TRegTypes.RegisterType('G720Interface.JIKMS', TypeInfo(G720Interface.JIKMS));
  TRegTypes.RegisterType('G720Interface.Jgedi_g', TypeInfo(G720Interface.Jgedi_g));
  TRegTypes.RegisterType('G720Interface.Ja_h', TypeInfo(G720Interface.Ja_h));
  TRegTypes.RegisterType('G720Interface.Jc_a', TypeInfo(G720Interface.Jc_a));
  TRegTypes.RegisterType('G720Interface.Jh_1', TypeInfo(G720Interface.Jh_1));
  TRegTypes.RegisterType('G720Interface.Jh_2', TypeInfo(G720Interface.Jh_2));
  TRegTypes.RegisterType('G720Interface.JIMSR', TypeInfo(G720Interface.JIMSR));
  TRegTypes.RegisterType('G720Interface.Jgedi_i', TypeInfo(G720Interface.Jgedi_i));
  TRegTypes.RegisterType('G720Interface.Ja_i', TypeInfo(G720Interface.Ja_i));
  TRegTypes.RegisterType('G720Interface.Ji_1', TypeInfo(G720Interface.Ji_1));
  TRegTypes.RegisterType('G720Interface.JIPM', TypeInfo(G720Interface.JIPM));
  TRegTypes.RegisterType('G720Interface.Jgedi_j', TypeInfo(G720Interface.Jgedi_j));
  TRegTypes.RegisterType('G720Interface.Ja_j', TypeInfo(G720Interface.Ja_j));
  TRegTypes.RegisterType('G720Interface.JIPRNTR', TypeInfo(G720Interface.JIPRNTR));
  TRegTypes.RegisterType('G720Interface.Jgedi_k', TypeInfo(G720Interface.Jgedi_k));
  TRegTypes.RegisterType('G720Interface.Ja_k', TypeInfo(G720Interface.Ja_k));
  TRegTypes.RegisterType('G720Interface.Jk_1', TypeInfo(G720Interface.Jk_1));
  TRegTypes.RegisterType('G720Interface.JISMART', TypeInfo(G720Interface.JISMART));
  TRegTypes.RegisterType('G720Interface.Jgedi_l', TypeInfo(G720Interface.Jgedi_l));
  TRegTypes.RegisterType('G720Interface.Ja_l', TypeInfo(G720Interface.Ja_l));
  TRegTypes.RegisterType('G720Interface.Jl_1', TypeInfo(G720Interface.Jl_1));
  TRegTypes.RegisterType('G720Interface.Jl_2', TypeInfo(G720Interface.Jl_2));
  TRegTypes.RegisterType('G720Interface.Jl_3', TypeInfo(G720Interface.Jl_3));
  TRegTypes.RegisterType('G720Interface.JISYS', TypeInfo(G720Interface.JISYS));
  TRegTypes.RegisterType('G720Interface.Jgedi_m', TypeInfo(G720Interface.Jgedi_m));
  TRegTypes.RegisterType('G720Interface.Ja_m', TypeInfo(G720Interface.Ja_m));
  TRegTypes.RegisterType('G720Interface.Ja_n', TypeInfo(G720Interface.Ja_n));
  TRegTypes.RegisterType('G720Interface.Ja_o', TypeInfo(G720Interface.Ja_o));
  TRegTypes.RegisterType('G720Interface.Jo_1', TypeInfo(G720Interface.Jo_1));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_e_ISO_Level', TypeInfo(G720Interface.JGEDI_CL_e_ISO_Level));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_e_ISO_Type', TypeInfo(G720Interface.JGEDI_CL_e_ISO_Type));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_e_MF_KeyType', TypeInfo(G720Interface.JGEDI_CL_e_MF_KeyType));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_e_MF_Type', TypeInfo(G720Interface.JGEDI_CL_e_MF_Type));
  TRegTypes.RegisterType('G720Interface.JGEDI_CRYPT_e_Op', TypeInfo(G720Interface.JGEDI_CRYPT_e_Op));
  TRegTypes.RegisterType('G720Interface.JGEDI_FS_e_Storage', TypeInfo(G720Interface.JGEDI_FS_e_Storage));
  TRegTypes.RegisterType('G720Interface.JGEDI_INFO_e_ControlNumber', TypeInfo(G720Interface.JGEDI_INFO_e_ControlNumber));
  TRegTypes.RegisterType('G720Interface.JGEDI_INFO_e_Test', TypeInfo(G720Interface.JGEDI_INFO_e_Test));
  TRegTypes.RegisterType('G720Interface.JGEDI_KBD_e_Key', TypeInfo(G720Interface.JGEDI_KBD_e_Key));
  TRegTypes.RegisterType('G720Interface.JGEDI_KBD_e_PowerKeyMode', TypeInfo(G720Interface.JGEDI_KBD_e_PowerKeyMode));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_BLOCKTYPE', TypeInfo(G720Interface.JGEDI_KMS_e_BLOCKTYPE));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_EncMode', TypeInfo(G720Interface.JGEDI_KMS_e_EncMode));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_KEYPURPOSE', TypeInfo(G720Interface.JGEDI_KMS_e_KEYPURPOSE));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_KEYTYPE', TypeInfo(G720Interface.JGEDI_KMS_e_KEYTYPE));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_KEYTYPE_LENGTH', TypeInfo(G720Interface.JGEDI_KMS_e_KEYTYPE_LENGTH));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_e_OP', TypeInfo(G720Interface.JGEDI_KMS_e_OP));
  TRegTypes.RegisterType('G720Interface.JGEDI_LED_e_Id', TypeInfo(G720Interface.JGEDI_LED_e_Id));
  TRegTypes.RegisterType('G720Interface.JGEDI_MSR_e_Status', TypeInfo(G720Interface.JGEDI_MSR_e_Status));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_e_Alignment', TypeInfo(G720Interface.JGEDI_PRNTR_e_Alignment));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_e_BarCodeType', TypeInfo(G720Interface.JGEDI_PRNTR_e_BarCodeType));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_e_Status', TypeInfo(G720Interface.JGEDI_PRNTR_e_Status));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_e_MemoryCardType', TypeInfo(G720Interface.JGEDI_SMART_e_MemoryCardType));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_e_Slot', TypeInfo(G720Interface.JGEDI_SMART_e_Slot));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_e_Status', TypeInfo(G720Interface.JGEDI_SMART_e_Status));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_e_Type', TypeInfo(G720Interface.JGEDI_SMART_e_Type));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_e_Voltage', TypeInfo(G720Interface.JGEDI_SMART_e_Voltage));
  TRegTypes.RegisterType('G720Interface.JGEDI_SYS_e_SecuritySetup', TypeInfo(G720Interface.JGEDI_SYS_e_SecuritySetup));
  TRegTypes.RegisterType('G720Interface.JGEDI_e_Ret', TypeInfo(G720Interface.JGEDI_e_Ret));
  TRegTypes.RegisterType('G720Interface.JGediException', TypeInfo(G720Interface.JGediException));
  TRegTypes.RegisterType('G720Interface.Jgedi_f', TypeInfo(G720Interface.Jgedi_f));
  TRegTypes.RegisterType('G720Interface.JILED', TypeInfo(G720Interface.JILED));
  TRegTypes.RegisterType('G720Interface.Jgedi_h', TypeInfo(G720Interface.Jgedi_h));
  TRegTypes.RegisterType('G720Interface.JIEnums', TypeInfo(G720Interface.JIEnums));
  TRegTypes.RegisterType('G720Interface.JGEDI_AUTH_st_Data', TypeInfo(G720Interface.JGEDI_AUTH_st_Data));
  TRegTypes.RegisterType('G720Interface.JGEDI_CLOCK_st_RTC', TypeInfo(G720Interface.JGEDI_CLOCK_st_RTC));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_st_ISO_PollingInfo', TypeInfo(G720Interface.JGEDI_CL_st_ISO_PollingInfo));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_st_MF_ActivateInfo', TypeInfo(G720Interface.JGEDI_CL_st_MF_ActivateInfo));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_st_MF_Key', TypeInfo(G720Interface.JGEDI_CL_st_MF_Key));
  TRegTypes.RegisterType('G720Interface.JGEDI_CL_st_ResetEMVInfo', TypeInfo(G720Interface.JGEDI_CL_st_ResetEMVInfo));
  TRegTypes.RegisterType('G720Interface.JGEDI_CRYPT_st_RSAKeyGen', TypeInfo(G720Interface.JGEDI_CRYPT_st_RSAKeyGen));
  TRegTypes.RegisterType('G720Interface.JGEDI_KBD_st_Info', TypeInfo(G720Interface.JGEDI_KBD_st_Info));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_CapturePINBlockInfo', TypeInfo(G720Interface.JGEDI_KMS_st_CapturePINBlockInfo));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_Control', TypeInfo(G720Interface.JGEDI_KMS_st_Control));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_Data', TypeInfo(G720Interface.JGEDI_KMS_st_Data));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_KB', TypeInfo(G720Interface.JGEDI_KMS_st_KB));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_PINBlock', TypeInfo(G720Interface.JGEDI_KMS_st_PINBlock));
  TRegTypes.RegisterType('G720Interface.JGEDI_KMS_st_SaveKey', TypeInfo(G720Interface.JGEDI_KMS_st_SaveKey));
  TRegTypes.RegisterType('G720Interface.JGEDI_MSR_st_LastErrors', TypeInfo(G720Interface.JGEDI_MSR_st_LastErrors));
  TRegTypes.RegisterType('G720Interface.JGEDI_MSR_st_Tracks', TypeInfo(G720Interface.JGEDI_MSR_st_Tracks));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_st_BarCodeConfig', TypeInfo(G720Interface.JGEDI_PRNTR_st_BarCodeConfig));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_st_PictureConfig', TypeInfo(G720Interface.JGEDI_PRNTR_st_PictureConfig));
  TRegTypes.RegisterType('G720Interface.JGEDI_PRNTR_st_StringConfig', TypeInfo(G720Interface.JGEDI_PRNTR_st_StringConfig));
  TRegTypes.RegisterType('G720Interface.JGEDI_SMART_st_ResetInfo', TypeInfo(G720Interface.JGEDI_SMART_st_ResetInfo));
  TRegTypes.RegisterType('G720Interface.Jsdk4_a_a', TypeInfo(G720Interface.Jsdk4_a_a));
  TRegTypes.RegisterType('G720Interface.Jsdk4_a_a_a', TypeInfo(G720Interface.Jsdk4_a_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_a_a', TypeInfo(G720Interface.Ja_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_b', TypeInfo(G720Interface.Ja_b));
  TRegTypes.RegisterType('G720Interface.Jb_a', TypeInfo(G720Interface.Jb_a));
  TRegTypes.RegisterType('G720Interface.Jb_a_a', TypeInfo(G720Interface.Jb_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_c', TypeInfo(G720Interface.Ja_c));
  TRegTypes.RegisterType('G720Interface.Jc_a_a', TypeInfo(G720Interface.Jc_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_d', TypeInfo(G720Interface.Ja_d));
  TRegTypes.RegisterType('G720Interface.Jd_a', TypeInfo(G720Interface.Jd_a));
  TRegTypes.RegisterType('G720Interface.Jd_a_a', TypeInfo(G720Interface.Jd_a_a));
  TRegTypes.RegisterType('G720Interface.Ja_e', TypeInfo(G720Interface.Ja_e));
  TRegTypes.RegisterType('G720Interface.Je_a', TypeInfo(G720Interface.Je_a));
  TRegTypes.RegisterType('G720Interface.Je_a_a', TypeInfo(G720Interface.Je_a_a));
  TRegTypes.RegisterType('G720Interface.Jsdk4_b_a', TypeInfo(G720Interface.Jsdk4_b_a));
  TRegTypes.RegisterType('G720Interface.Jsdk4_b_a_a', TypeInfo(G720Interface.Jsdk4_b_a_a));
  TRegTypes.RegisterType('G720Interface.Jb_a_a_a', TypeInfo(G720Interface.Jb_a_a_a));
  TRegTypes.RegisterType('G720Interface.Jb_b', TypeInfo(G720Interface.Jb_b));
  TRegTypes.RegisterType('G720Interface.Jb_b_a', TypeInfo(G720Interface.Jb_b_a));
  TRegTypes.RegisterType('G720Interface.Jb_b_a_a', TypeInfo(G720Interface.Jb_b_a_a));
  TRegTypes.RegisterType('G720Interface.Jsdk4_c_a', TypeInfo(G720Interface.Jsdk4_c_a));
  TRegTypes.RegisterType('G720Interface.Jsdk4_c_a_a', TypeInfo(G720Interface.Jsdk4_c_a_a));
  TRegTypes.RegisterType('G720Interface.Jc_a_b', TypeInfo(G720Interface.Jc_a_b));
  TRegTypes.RegisterType('G720Interface.Jc_b', TypeInfo(G720Interface.Jc_b));
  TRegTypes.RegisterType('G720Interface.Jlibbasebinder_a', TypeInfo(G720Interface.Jlibbasebinder_a));
  TRegTypes.RegisterType('G720Interface.JBankCard', TypeInfo(G720Interface.JBankCard));
  TRegTypes.RegisterType('G720Interface.JCore', TypeInfo(G720Interface.JCore));
  TRegTypes.RegisterType('G720Interface.Jlibbasebinder_Printer', TypeInfo(G720Interface.Jlibbasebinder_Printer));
  TRegTypes.RegisterType('G720Interface.JPrinter_Align', TypeInfo(G720Interface.JPrinter_Align));
  TRegTypes.RegisterType('G720Interface.JPrinter_BarcodeType', TypeInfo(G720Interface.JPrinter_BarcodeType));
  TRegTypes.RegisterType('G720Interface.JPrinter_BarcodeWidth', TypeInfo(G720Interface.JPrinter_BarcodeWidth));
  TRegTypes.RegisterType('G720Interface.JPrinter_Font', TypeInfo(G720Interface.JPrinter_Font));
  TRegTypes.RegisterType('G720Interface.JRspCode', TypeInfo(G720Interface.JRspCode));
  TRegTypes.RegisterType('G720Interface.Ja_1', TypeInfo(G720Interface.Ja_1));
  TRegTypes.RegisterType('G720Interface.Ja_2', TypeInfo(G720Interface.Ja_2));
  TRegTypes.RegisterType('G720Interface.Jlibbasebinder_a_a', TypeInfo(G720Interface.Jlibbasebinder_a_a));
  TRegTypes.RegisterType('G720Interface.Jlibbasebinder_b', TypeInfo(G720Interface.Jlibbasebinder_b));
end;
