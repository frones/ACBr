...
uses
  ...
  ACBrDISGertecSerial, ACBrDISGertecTeclado, ACBrDISGertecTEC65lib, 
  ACBrDISKeytecTeclado, ACBrDISSmakTecladoLib, ACBrDISSmakTeclado, 
  ACBrDISSmakSerial, ACBrECF, ACBrECFClass, ACBrECFBematech, ACBrECFDaruma, 
  ACBrECFDataRegis, ACBrECFEpson, ACBrECFEscECF, ACBrECFFiscNET, ACBrECFICash, 
  ACBrECFMecaf, ACBrECFNaoFiscal, ACBrECFNCR, ACBrECFQuattro, ACBrECFSchalter, 
  ACBrECFSweda, ACBrECFSwedaSTX, ACBrECFUrano, ACBrECFVirtual, 
  ACBrECFVirtualBuffer, ACBrECFVirtualNaoFiscal, ACBrECFVirtualPrinter, 
  ACBrECFYanco, ACBrEscBematech, ACBrEscCustomPos, ACBrEscDaruma, 
  ACBrEscDatecs, ACBrEscDiebold, ACBrEscElgin, ACBrEscEpsonP2, 
  ...
  ACBrTER, ACBrTERClass, ACBrTERWilbor, LazarusPackageIntf;
