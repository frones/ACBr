...
namespace ACBrLib.AbecsPinpad
{
    ...
    public sealed partial class ACBrAbecsPinpad : ACBrLibHandle
    {
        ...
        public void CLO(string sMensagem = "")
        {
            ...
            var ret = ExecuteMethod(() => method(ToUTF8(sMensagem)));
        ...
        public void CLX(string sMensagemOuNomeImagem = "")
        {
            ...
            var ret = ExecuteMethod(() => method(ToUTF8(sMensagemOuNomeImagem)));
        ...
        public string GIX(string PP_DATA)
        {
            ...
            var ret = ExecuteMethod(() => method(ToUTF8(PP_DATA), buffer, ref bufferLen));
        ...
        public string GIN(int GIN_ACQIDX)
        {
            ...
            var ret = ExecuteMethod(() => method(GIN_ACQIDX, buffer, ref bufferLen));
        ...
        public void DSP(string sMensagem)
        {
            ...
            var ret = ExecuteMethod(() => method(sMensagem));
        ...
        public void RMC(string sMensagemRMC)
        {
            ...
            var ret = ExecuteMethod(() => method(sMensagemRMC));
        ...
        public string GCD(int aMSGIDX, int aTimeOut)
        {
            ...
            var ret = ExecuteMethod(() => method(aMSGIDX, aTimeOut, buffer, ref bufferLen));
        ...
        public string CEX(bool VerifyKey, bool VerifyMagnetic, bool VerifyICCInsertion, bool VerifyICCRemoval, bool VerifyCTLSPresence, int aTimeOut)
        {
            ...
            var ret = ExecuteMethod(() => method(VerifyKey, VerifyMagnetic, VerifyICCInsertion, VerifyICCRemoval, VerifyCTLSPresence, aTimeOut, buffer, ref bufferLen));
        ...
        public string MNU(string sMNUOPT, string sDSPMSG, int aTimeOut)
        {
            ...
            var ret = ExecuteMethod(() => method(sMNUOPT, sDSPMSG, aTimeOut, buffer, ref bufferLen));
        ...
        public string LoadMedia(string sCaminhoImagem, int aTipoImagem)
        {
            ...
            var ret = ExecuteMethod(() => method(sCaminhoImagem, aTipoImagem, buffer, ref bufferLen));
        ...
        public void DSI(string sNomeArquivo)
        {
            ...
            var ret = ExecuteMethod(() => method(sNomeArquivo));
