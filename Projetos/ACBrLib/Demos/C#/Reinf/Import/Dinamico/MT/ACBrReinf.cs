...
namespace ACBrLib.Reinf
{
    ...
    public sealed partial class ACBrReinf : ACBrLibHandle
    {
        ...
        public string CriarEnviarReinf(string eArqIni)
        {
            ...
            var ret = ExecuteMethod(() => method(libHandle, ToUTF8(eArqIni), buffer, ref bufferLen));
        ...
        public void SetIDContribuinte(string aIdContribuinte)
        {
            ...
            var ret = ExecuteMethod(() => method(libHandle, ToUTF8(aIdContribuinte)));
        ...
        public void TipoContribuinte(int aTipoContribuinte)
        {
            ...
            var ret = ExecuteMethod(() => method(libHandle, aTipoContribuinte));
        ...
        public string OpenSSLInfo()
        {
            ...
            var method = GetMethod<Reinf_OpenSSLInfo>();
            var ret = ExecuteMethod(() => method(libHandle, buffer, ref bufferLen));
