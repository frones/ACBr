...
namespace ACBrLib.Core.NFSe
{
    public enum CodigoMunicipio
    {
        ...
        [EnumValue("4302105")]
        [Description("Bento Gonçalves - RS")]
        ...
        [EnumValue("3548708")]
        [Description("Sao Bernardo do Campos - SP")]
        SaoBernardodoCampos = 3548708,
