 ...
 * seu escopo.
 */
public final class ACBrCTe extends ACBrLibBase {
    private interface ACBrCTeLib extends Library {
            ...
            public static ACBrCTeLib getInstance() {
                if (instance == null) {
                    instance = (ACBrCTeLib) Native.synchronizedLibrary(
                            (Library) Native.load(JNA_LIBRARY_NAME, ACBrCTeLib.class));
                }
        ...
        int CTE_DistribuicaoDFePorUltNSU(int AcUFAutor, String eCNPJCPF, String eultNsu, ByteBuffer buffer, IntByReference bufferSize);

        int CTE_DistribuicaoDFePorNSU(int AcUFAutor, String eCNPJCPF, String eNSU, ByteBuffer buffer, IntByReference bufferSize);

        int CTE_DistribuicaoDFePorChave(int AcUFAutor, String eCNPJCPF, String echNFe, ByteBuffer buffer, IntByReference bufferSize);
