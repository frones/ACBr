...
public final class ACBrConsultaCNPJ extends ACBrLibBase {
    ...
    private interface ACBrConsultaCNPJLib extends Library {
        ...
        int CNPJ_Consultar(Pointer libHanPointer, String eCNPJ, String eCaptcha, ByteBuffer buffer, IntByReference bufferSize);
    ...
    public String Consultar(String eCNPJ, String eCaptcha) throws Exception {
     
        ByteBuffer buffer = ByteBuffer.allocate(STR_BUFFER_LEN);
        IntByReference bufferLen = new IntByReference(STR_BUFFER_LEN);
        
        int ret = ACBrConsultaCNPJLib.INSTANCE.CNPJ_Consultar(getHandle(), eCNPJ, eCaptcha, buffer, bufferLen);
        checkResult(ret);
