...
public class FrmMain extends javax.swing.JFrame {
    ...
    private void btnInfoImpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoImpActionPerformed
        try {
            String info = posPrinter.lerInfoImpressora();
            txtImprimir.setText(info);
        } catch (Exception ex) {
    ...
    private void btnStatusImpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStatusImpActionPerformed
        try {
            Set<ACBrPosTipoStatus> statusSet = posPrinter.lerStatusImpressora();
            txtImprimir.setText("");
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        try {
            posPrinter.imprimir(txtImprimir.getText());
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex);
        }
