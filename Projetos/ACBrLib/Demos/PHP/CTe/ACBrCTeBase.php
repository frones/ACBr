...
<head>
    <meta charset="UTF-8">
    <meta name="ACBrCTe" content="width=device-width, initial-scale=1.0">
    <title>
        <?php
        $title = 'ACBrCTe';
        if (isset($_GET['modo']))
        ...
        <div class="tabsPanel">
            ...
            <div id="configuracoes" class="panelAba selecionado panelEsquerda-container">
                <div class="tabsPanel">
                    ...
                    <div id="geral" class="panelAba selecionado panelConfiguracoes-container">
                        ...
                        <div class="form-group">
                            ...
                            <select id="modeloDF" name="modeloDF">
                                <option value="0" selected>moCTe</option>
                                <option value="1">moGTVe</option>
                                <option value="2">moCTeOS</option>
                                <option value="3">moCTeSimp</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="versaoDF" name="versaoDF">
                                ...
                                <option value="2" selected>ve400</option>
                            </select>
                        </div>
                        <div class="grid2Col">
                    ...
                    <div id="arquivos" class="panelAba panelConfiguracoes-container">
                        ...
                        <div class="grid2Col">
                            <label for="EmissaoPathCTe">Salvar Doc. pelo campo Data de Emissão</label>
                            <input type="checkbox" id="EmissaoPathCTe">
                        </div>
                        <div class="grid2Col">
                        ...
                        <br>
                        <div class="form-group">
                            <label for="PathCTe">Pasta Arquivos CTe</label>
                            <input type="text" id="PathCTe">
                        </div>
                        <div class="form-group">
            ...
            <div id="documento-auxiliar" class="panelAba panelEsquerda-container">
                ...
                <div class="grid2Col">
                    <label>DACTe</label>
                    <div>
                        <input type="radio" id="dacteRetrato" name="TipoDACTe" value="0" checked>
                        <label for="dacteRetrato">Retrato</label>
                        <input type="radio" id="dactePaisagem" name="TipoDACTe" value="1">
                        <label for="dactePaisagem">Paisagem</label>
                    </div>
                </div>
            </div>
        ...
        <div class="tabsPanel">
            ...
            <div id="envio" class="panelAba selecionado button-container">
                <div class="grid3Col">
                    ...
                    <input type="button" id="ImprimirPDF" value="Imprimir PDF DACTe">
                    ...
                    <input type="button" id="GerarChave" value="Gerar Chave CTe">
                    <input type="button" id="EnviarEmail" value="Enviar CTe Email">
                </div>
            </div>
            ...
            <div id="eventos" class="panelAba button-container">
                <div class="grid2Col">
                    <input type="button" id="Cancelar" value="Cancelar CTe">
    ...
    <script>
        ...
        $('#salvarConfiguracoes').on('click', function() {
            const infoData = {
                ...
                EmissaoPathCTe: $('#EmissaoPathCTe').prop('checked') ? 1 : 0,
                ...
                TipoDACTe: parseInt($('input[name="TipoDACTe"]:checked').val(), 10),
        ...
        $('#ValidarRegrasdeNegocios').on('click', function() {
            selecionarArquivo(".xml", function(AeArquivoXmlCTe) {
                chamaAjaxEnviar({
                    metodo: "ValidarRegrasdeNegocios",
                    AeArquivoXmlCTe: AeArquivoXmlCTe
                });
            });
        });
        ...
        $('#ConsultarComChave').on('click', function() {
            inputBox("Digite a chave da CTe:", function(eChaveOuCTe) {
                chamaAjaxEnviar({
                    metodo: "Consultar",
                    eChaveOuCTe: eChaveOuCTe,
                    AExtrairEventos: 1
                });
            });
        });
        ...
        $('#EnviarSincronoXml').on('click', function() {
            selecionarArquivo(".xml", function(AeArquivoCTe) {
                inputBox("Digite o Lote:", function(ALote) {
                    chamaAjaxEnviar({
                        metodo: "Enviar",
                        tipoArquivo: "xml",
                        AeArquivoCTe: AeArquivoCTe,
                        ALote: ALote,
                        AImprimir: 0,
                        ASincrono: 1
                    });
        ...
        $('#EnviarSincronoIni').on('click', function() {
            selecionarArquivo(".ini", function(AeArquivoCTe) {
                inputBox("Digite o Lote:", function(ALote) {
                    chamaAjaxEnviar({
                        metodo: "Enviar",
                        tipoArquivo: "ini",
        ...
        $('#DistribuicaoDFePorChave').on('click', function() {
            inputBox("Digite o código da UF:", function(AcUFAutor) {
                inputBox("Digite o CNPJ:", function(AeCNPJCPF) {
                    inputBox("Digite a chave:", function(AechCTe) {
                        chamaAjaxEnviar({
        ...
        $('#EnviarEmail').on('click', function() {
            selecionarArquivo(".xml", function(AeArquivoXmlCTe) {
                inputBox("Digite o endereço do destinatário:", function(AePara) {
                    inputBox("Digite a chave da CTe:", function(AeChaveCTe) {
                        inputBox("Enviar PDF? (0)Não (1) Sim", function(AEnviaPDF) {
                            chamaAjaxEnviar({
                                metodo: "EnviarEmail",
                                AeArquivoXmlCTe: AeArquivoXmlCTe,
                                AePara: AePara,
                                AeChaveCTe: AeChaveCTe,
                                AEnviaPDF: AEnviaPDF,
                ...
                selecionarArquivo(".xml", function(AeArquivoXmlEvento) {
                    inputBox("Digite o endereço do destinatário:", function(AePara) {
                        inputBox("Digite a chave do evento:", function(AeChaveEvento) {
                            inputBox("Digite a chave do CTe:", function(AeChaveCTe) {
                                inputBox("Enviar PDF? (0)Não (1) Sim", function(AEnviaPDF) {
                                    chamaAjaxEnviar({
        ...
        function chamaAjaxEnviar(infoData) {
            ...
            // Ex: http://localhost/CTe/ACBrCTeBase.php?modo=MT
            // Ex: http://localhost/CTe/ACBrCTeBase.php?modo=ST
            var modo = "<?php echo $modo; ?>";
            if (modo == "")
                modo = "MT";

            $.ajax({
                url: modo + '/ACBrCTeServicos' + modo + '.php',
                type: 'POST',
                data: infoData,
        ...
        function processaRetornoConfiguracoes(response) {
            if (response.dados) {
                ...
                $('#EmissaoPathCTe').prop('checked', response.dados.EmissaoPathCTe == 1);
                ...
                $('#PathCTe').val(response.dados.PathCTe);
                ...
                $('input[name="TipoDACTe"][value="' + response.dados.TipoDACTe + '"]').prop('checked', true);
