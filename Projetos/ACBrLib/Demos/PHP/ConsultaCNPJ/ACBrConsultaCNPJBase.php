...
<body>
    ...
    <script>
        ...
        function chamaAjaxEnviar(infoData) {
            ...
            // Ex: http://localhost/ConsultaCNPJ/ACBrConsultaCNPJBase.php?modo=MT
            // Ex: http://localhost/ConsultaCNPJ/ACBrConsultaCNPJBase.php?modo=ST
            var modo = "<?php echo $modo; ?>";
            if (modo == "")
                modo = "MT";

            $.ajax({
                url: modo + '/ACBrConsultaCNPJServicos' + modo + '.php',
                type: 'POST',
                data: infoData,
                success: function(response) {
                    ...
                    } else if (infoData.metodo === "Consultar") {
