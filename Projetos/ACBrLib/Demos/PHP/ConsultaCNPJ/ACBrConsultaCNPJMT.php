...
<body>
    ...
    <form id="formConsulta">
        ...
        <label for="usuario"><?php echo mb_convert_encoding("Usuário:", "UTF-8", "ISO-8859-1"); ?></label>
        ...
        <input type="button" id="salvarConfiguracoes" value="<?php echo mb_convert_encoding('Salvar Configurações', 'UTF-8', 'ISO-8859-1'); ?>">
        <input type="button" id="carregarConfiguracoes" value="<?php echo mb_convert_encoding('Carregar Configurações', 'UTF-8', 'ISO-8859-1'); ?>">
    </form>
    ...
    <div class="retornoCampos">
      ...
      <div class="retornoCamposColuna">
        <label for="endereco"><?php echo mb_convert_encoding("Endereço", "UTF-8", "ISO-8859-1"); ?></label>
      ...
      <div class="retornoCamposColuna">
        <label for="inscricaoEstadual"><?php echo mb_convert_encoding("Inscrição Estadual", "UTF-8", "ISO-8859-1"); ?></label>
        <input type="text" id="inscricaoEstadual" name="inscricaoEstadual"><br>
      </div>
      <div class="retornoCamposColuna">
        <label for="naturezaJuridica"><?php echo mb_convert_encoding("Natureza Jurídica", "UTF-8", "ISO-8859-1"); ?></label>
        <input type="text" id="naturezaJuridica" name="naturezaJuridica"><br>
      </div>
      <div class="retornoCamposColuna">
        <label for="numero"><?php echo mb_convert_encoding("Número", "UTF-8", "ISO-8859-1"); ?></label>
        <input type="text" id="numero" name="numero"><br>
      </div>
      <div class="retornoCamposColuna">
        <label for="razaoSocial"><?php echo mb_convert_encoding("Razão Social", "UTF-8", "ISO-8859-1"); ?></label>
        <input type="text" id="razaoSocial" name="razaoSocial"><br>
      </div>
      <div class="retornoCamposColuna">
        <label for="situacao"><?php echo mb_convert_encoding("Situação", "UTF-8", "ISO-8859-1"); ?></label>
