...
try {
    ...
    if ($metodo == "salvarConfiguracoes") {
        ...
        if (ConfigGravarValor($ffi, "IBGE", "IgnorarCaixaEAcentos", $_POST['IgnorarCaixaEAcentos']) != 0) exit;
    ...
    if ($metodo == "carregarConfiguracoes") {
        ...
        if (ConfigLerValor($ffi, "IBGE", "IgnorarCaixaEAcentos", $IgnorarCaixaEAcentos) != 0) exit;
    ...
    if (($metodo == "BuscarPorCodigo") || ($metodo == "BuscarPorNome")) {
        ...
        if ($metodo == "BuscarPorCodigo")
            $resultado = BuscarPorCodigo($ffi, $_POST['ACodMun'], $iniContent);
        else
            $resultado = BuscarPorNome($ffi, $_POST['cidadecons'], $_POST['ufcons'], $iniContent);
