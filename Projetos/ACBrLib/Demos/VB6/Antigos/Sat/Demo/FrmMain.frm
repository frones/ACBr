...
Private Sub LoadConfig()
    ...
    retorno = SAT_ConfigLerValor("Extrato", "MostraPreview", buffer, bufferLen)
    CheckResult ret
    ...
    retorno = SAT_ConfigLerValor("Extrato", "MostraSetup", buffer, bufferLen)
    CheckResult ret
    ...
    retorno = SAT_ConfigLerValor("Extrato", "ImprimeCodigoEan", buffer, bufferLen)
    CheckResult ret
...
Private Sub SaveConfig()
    ...
    retorno = SAT_ConfigGravarValor("Extrato", "MostraPreview", CStr(chkPreview.Value))
    CheckResult ret
    
    retorno = SAT_ConfigGravarValor("Extrato", "MostraSetup", CStr(chkSetup.Value))
    CheckResult ret
    
    retorno = SAT_ConfigGravarValor("Extrato", "ImprimeCodigoEan", CStr(chkUsaCodigoEanImpressao.Value))
    CheckResult ret
