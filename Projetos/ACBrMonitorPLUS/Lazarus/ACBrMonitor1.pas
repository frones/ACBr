...
begin
  ...
  try
    ...
    cbPortaESCPOS.ItemIndex :=
      cbPortaESCPOS.Items.IndexOf(Ini.ReadString('NFCe', 'Porta', 'COM1'));
    cbVelocidadeESCPOS.ItemIndex :=
      cbVelocidadeESCPOS.Items.IndexOf(Ini.ReadString('NFCe', 'Velocidade', '9600'));
