...
Uses Classes, TypInfo, SysUtils, CmdUnit, Types, StdCtrls,
...
Uses IniFiles, StrUtils, DateUtils,
  Windows, Forms,
  ACBrUtil, ACBrMonitor1 , ACBrNFeWebServices, ACBrNFe,
...
//                  raise Exception.Create(ACBrNFe1.WebServices.StatusServico.Msg);
         ...
         begin
           ...
           if (Cmd.Params(2) = '1') then
            ...
            try
               EnviarEmail(edtSmtpHost.Text, edtSmtpPort.Text, edtSmtpUser.Text, edtSmtpPass.Text, edtSmtpUser.Text, Cmd.Params(0),IfThen(NaoEstaVazio(Cmd.Params(3)),Cmd.Params(3),edtEmailAssunto.Text), ArqNFe, ArqPDF, mmEmailMsg.Lines, cbEmailSSL.Checked, cbEmailTLS.Checked, Cmd.Params(4));
         ...
         begin
           ...
           if (Cmd.Params(3) = '1') then
            ...
            try
               EnviarEmail(edtSmtpHost.Text, edtSmtpPort.Text, edtSmtpUser.Text, edtSmtpPass.Text, edtSmtpUser.Text, Cmd.Params(0),IfThen(NaoEstaVazio(Cmd.Params(4)),Cmd.Params(4),edtEmailAssunto.Text), ArqEvento, ArqPDF, mmEmailMsg.Lines, cbEmailSSL.Checked, cbEmailTLS.Checked, Cmd.Params(5));
               Cmd.Resposta := 'Email enviado com sucesso';
            except
               on E: Exception do
                begin
         ...
         begin
           ...
           ACBrNFe1.NotasFiscais.Items[0].GravarXML(ChangeFileExt(ACBrNFe1.NotasFiscais.Items[0].NomeArq,'.txt'),Cmd.Params(1));
