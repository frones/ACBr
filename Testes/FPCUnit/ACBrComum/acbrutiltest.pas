...
begin
  ...
  CheckEquals(ACBrStr('¿'), HexToAscii('C0'));
  CheckEquals(ACBrStr('¡'), HexToAscii('C1'));
  CheckEquals(ACBrStr('√'), HexToAscii('C3'));
  CheckEquals(ACBrStr('¬'), HexToAscii('C2'));
  CheckEquals(ACBrStr('‡'), HexToAscii('E0'));
  CheckEquals(ACBrStr('·'), HexToAscii('E1'));
  CheckEquals(ACBrStr('„'), HexToAscii('E3'));
  CheckEquals(ACBrStr('‚'), HexToAscii('E2'));
  CheckEquals(ACBrStr('»'), HexToAscii('C8'));
  CheckEquals(ACBrStr('…'), HexToAscii('C9'));
  CheckEquals(ACBrStr(' '), HexToAscii('CA'));
  CheckEquals(ACBrStr('Ë'), HexToAscii('E8'));
  CheckEquals(ACBrStr('È'), HexToAscii('E9'));
  CheckEquals(ACBrStr('Í'), HexToAscii('EA'));
  CheckEquals(ACBrStr('Ã'), HexToAscii('CC'));
  CheckEquals(ACBrStr('Õ'), HexToAscii('CD'));
  CheckEquals(ACBrStr('Œ'), HexToAscii('CE'));
  CheckEquals(ACBrStr('Ï'), HexToAscii('EC'));
  CheckEquals(ACBrStr('Ì'), HexToAscii('ED'));
  CheckEquals(ACBrStr('Ó'), HexToAscii('EE'));
  CheckEquals(ACBrStr('“'), HexToAscii('D2'));
  CheckEquals(ACBrStr('”'), HexToAscii('D3'));
  CheckEquals(ACBrStr('’'), HexToAscii('D5'));
  CheckEquals(ACBrStr('‘'), HexToAscii('D4'));
  CheckEquals(ACBrStr('Ú'), HexToAscii('F2'));
  CheckEquals(ACBrStr('Û'), HexToAscii('F3'));
  CheckEquals(ACBrStr('ı'), HexToAscii('F5'));
  CheckEquals(ACBrStr('Ù'), HexToAscii('F4'));
  CheckEquals(ACBrStr('Ÿ'), HexToAscii('D9'));
  CheckEquals(ACBrStr('⁄'), HexToAscii('DA'));
  CheckEquals(ACBrStr('€'), HexToAscii('DB'));
  CheckEquals(ACBrStr('˘'), HexToAscii('F9'));
  CheckEquals(ACBrStr('˙'), HexToAscii('FA'));
  CheckEquals(ACBrStr('˚'), HexToAscii('FB'));
  CheckEquals(ACBrStr('«'), HexToAscii('C7'));
  CheckEquals(ACBrStr('Á'), HexToAscii('E7'));
  CheckEquals(ACBrStr('—'), HexToAscii('D1'));
  CheckEquals(ACBrStr('Ò'), HexToAscii('F1'));
end;
