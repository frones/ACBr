...
begin
  CheckEquals(ACBrStr('·'), HexToAscii(DevolveHexStrParaConverter('&#xE1;')));
  CheckEquals(ACBrStr('È'), HexToAscii(DevolveHexStrParaConverter('&#xE9;')));
  CheckEquals(ACBrStr('Ì'), HexToAscii(DevolveHexStrParaConverter('&#xED;')));
  CheckEquals(ACBrStr('Û'), HexToAscii(DevolveHexStrParaConverter('&#xF3;')));
  CheckEquals(ACBrStr('˙'), HexToAscii(DevolveHexStrParaConverter('&#xFA;')));
  CheckEquals(ACBrStr('Á'), HexToAscii(DevolveHexStrParaConverter('&#xE7;')));
  CheckEquals(ACBrStr('Ò'), HexToAscii(DevolveHexStrParaConverter('&#xF1;')));
  CheckEquals(ACBrStr('¡'), HexToAscii(DevolveHexStrParaConverter('&#xC1;')));
  CheckEquals(ACBrStr('…'), HexToAscii(DevolveHexStrParaConverter('&#xC9;')));
  CheckEquals(ACBrStr('Õ'), HexToAscii(DevolveHexStrParaConverter('&#xCD;')));
  CheckEquals(ACBrStr('”'), HexToAscii(DevolveHexStrParaConverter('&#xD3;')));
  CheckEquals(ACBrStr('⁄'), HexToAscii(DevolveHexStrParaConverter('&#xDA;')));
  CheckEquals(ACBrStr('«'), HexToAscii(DevolveHexStrParaConverter('&#xC7;')));
  CheckEquals(ACBrStr('—'), HexToAscii(DevolveHexStrParaConverter('&#xD1;')));
end;
...
begin
  ...
  try
    ...
    Check(XmlEhUTF8BOOM(LXML), 'Falhou ao definir se È UTF8BOM');
  finally
    LMS.Free;
  end;
end;
...
begin
  ...
  try
    ...
    Check(not XmlEhUTF8BOOM(LXML), 'Falhou ao definir se È UTF8BOM');
  finally
    LMS.Free;
  end;
end;
